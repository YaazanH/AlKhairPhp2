...
return [
    ...
    'highlights' => [
        ...
        'final_tests' => 'Final-tested juz',
    ],
    'students_title' => 'Student course results',
    'sorted_notice' => 'Sorted by calculated points after rules',
    'final_tests_title' => 'Final tests',
    'empty' => 'No enrolled students were found for this course.',
    'table' => [
        'name' => 'Name', 'group' => 'Group', 'points_after' => 'Total points after rules',
        'days_attended' => 'Days attended', 'pages' => 'Pages memorized', 'final_tests' => 'Juz final tested',
        'final_score' => 'Final-test score', 'juz' => 'Juz no.', 'mark' => 'Mark',
    ],
    'report_cards' => 'Student report cards',
    'report_cards_help' => 'Create a reusable print template and print it only for students with a passed final test.',
