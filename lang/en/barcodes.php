...
return [
    ...
    'import' => [
        ...
        'context' => [
            'copy' => 'Choose the course first so every student barcode is matched against the correct active enrolment.',
        ...
        'errors' => [
            ...
            'multiple_enrollments_in_course' => ':student has more than one active enrolment in the selected course.',
            'no_enrollment_in_course' => ':student does not have an active enrolment in the selected course.',
