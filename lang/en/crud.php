...
return [
    ...
    'courses' => [
        ...
        'confirm_deactivate' => 'Finish this course and archive its groups, enrolments, assessments, and attendance?',
        'copy' => [
            'confirm' => 'Copy this course and its group metadata without students or enrolments?',
            'confirm_archive' => 'Copy this archived course and its group metadata to the current academic year without students or enrolments?',
            'name' => ':name copy',
        ...
        'archive' => [
            ...
            'enrollments' => 'Archived enrolments',
    ...
    'students' => [
        ...
        'focus' => [
            ...
            'create_help' => 'Create the core profile first. Media, notes, and enrolment workflows open from the student record table.',
            'edit_help' => 'Update the selected profile, then manage files, notes, and enrolments from the record actions.',
        ],
        'stats' => [
            'all' => [
            ...
            'active' => [
                'label' => 'Active',
                'description' => 'Students available for current enrolment and operational workflows.',
            ],
            'graduated' => [
                'label' => 'Graduated',
        ...
        'form' => [
            ...
            'fields' => [
                ...
                'external_memorized_juzs' => 'Previously memorised juz',
                'status' => 'Status',
                'media' => 'Media',
                'joined_at' => 'Joined at',
                'notes' => 'Notes',
        ...
        'errors' => [
            'delete_linked' => 'This student cannot be deleted while enrolments still exist.',
            'delete_memorization' => 'This student cannot be deleted because memorisation or Quran page progress exists.',
    ...
    'groups' => [
        ...
        'stats' => [
            ...
            'active' => [
                'label' => 'Active groups',
                'description' => 'Groups currently available for schedules, attendance, and enrolment work.',
            ],
        ],
        'form' => [
            ...
            'help' => 'Set the operational details that drive schedules, attendance, and enrolment. Course dates are managed from the course record.',
            'fields' => [
                'name' => 'Group name',
                'course' => 'Course',
                'academic_year' => 'Academic year',
        ...
        'messages' => [
            ...
            'deactivated' => 'Group and enrolments were deactivated successfully.',
        ...
        'confirm_deactivate' => 'Deactivate this group and its enrolments?',
        'errors' => [
            'delete_linked' => 'This group cannot be deleted while enrolments or schedules still exist.',
        ...
        'quick_summary' => [
            ...
            'help' => 'Choose a date, review each student attendance and memorisation for that day, then copy the text as a parent-ready message.',
            ...
            'memorization_missing' => 'No memorisation recorded',
            'memorization_unavailable' => 'Memorisation data unavailable',
    ...
    'enrollments' => [
        'hero' => [
            ...
            'title' => 'Enrolments',
            'subtitle' => 'Manage the student-to-group links that drive attendance, memorisation, points, assessments, and finance.',
            'badges' => [
        ...
        'focus' => [
            'eyebrow' => 'Enrolment focus',
            'create_title' => 'New enrolment link',
            'edit_title' => 'Editing enrolment',
        ...
        'stats' => [
            ...
            'completed' => [
                'label' => 'Completed',
                'description' => 'Enrolments that have finished their active lifecycle.',
            ],
        ],
        'form' => [
            'eyebrow' => 'Enrolment editor',
            'create_title' => 'Create enrolment',
            'edit_title' => 'Edit enrolment',
            'help' => 'Cached points and memorised pages stay automatic. This form manages the enrolment anchor only.',
            'fields' => [
                'student' => 'Student',
                'group' => 'Group',
                'enrolled_at' => 'Enrolled at',
            ...
            'no_available_students' => 'All scoped students are already enrolled in this group.',
            'create_submit' => 'Create enrolment',
            'update_submit' => 'Update enrolment',
        ],
        'read_only' => [
            'title' => 'Enrolment records',
            'description' => 'You can view enrolment records, but you do not have permission to create or edit them.',
        ],
        'table' => [
            'eyebrow' => 'Enrolment map',
            'title' => 'Enrolment records',
        ...
        'messages' => [
            'created' => 'Enrolment created successfully.',
            'updated' => 'Enrolment updated successfully.',
