...
return [
    'common' => [
        ...
        'source_type' => [
            ...
            'quran_partial_test' => 'Partial test completion',
            'quran_partial_test_part' => 'Partial test part',
            'quran_final_test' => 'Final test',
            'quran_test' => 'Awqaf test',
        ...
        'actions' => [
            ...
            'save_quran_test' => 'Save awqaf test',
    ...
    'quran_tests' => [
        'title' => 'Awqaf Tests',
        'subtitle' => 'Record awqaf tests only after the standalone final test for the same juz has passed.',
        'workbench' => [
        ...
        'read_only' => [
            'title' => 'Read-only access',
            'description' => 'You can review awqaf tests, but you do not have permission to record them.',
        ],
        'table' => [
            'title' => 'Awqaf test history',
            'empty' => 'No awqaf tests have been recorded for this enrollment yet.',
            'headers' => [
                'date' => 'Date',
                'juz' => 'Juz',
                'type' => 'Type',
    ...
    'quran_partial_tests' => [
        ...
        'actions' => [
            'create' => 'New partial test',
            'open' => 'Open details',
            'back' => 'Back to partial tests',
            'record_attempt' => 'Record attempt',
            'save_attempt' => 'Save attempt',
        ],
        'form' => [
            'title' => 'New partial test',
        ...
        'table' => [
            ...
            'empty' => 'No partial tests match the current scope yet.',
            'headers' => [
                'student' => 'Student',
                'group' => 'Group',
                'juz' => 'Juz',
    ...
    'quran_final_tests' => [
        ...
        'actions' => [
            ...
            'open' => 'Open details',
            'back' => 'Back to final tests',
            'record_attempt' => 'Record attempt',
            'save_attempt' => 'Save attempt',
        ],
        'form' => [
            'title' => 'New final test',
            ...
            'select_juz' => 'Select juz',
            'group_auto' => 'The active group was selected automatically.',
            'no_eligible_juzs' => 'This student has no passed partial cycle available for a new final test.',
        ],
        'messages' => [
        ...
        'table' => [
            'title' => 'Final test cycles',
            'copy' => 'Each row represents one juz-level final-test cycle with its full attempt history.',
            'empty' => 'No final tests match the current scope yet.',
            'headers' => [
                'student' => 'Student',
                'group' => 'Group',
                'juz' => 'Juz',
        ...
        'details' => [
            ...
            'subtitle' => 'Record each final-test attempt until the student passes. Once the test passes, the cycle is locked.',
        ...
        'warnings' => [
            'open_cycle_title' => 'Student already has an open final test',
            ...
            'open_existing' => 'Open existing final test',
    ...
    'student_progress' => [
        ...
        'partial_tests' => [
            'title' => 'Quran partial tests',
            'empty' => 'No partial tests have been recorded yet.',
            'headers' => [
                'group' => 'Group',
                'juz' => 'Juz',
                'parts' => 'Passed parts',
        ...
        'final_tests' => [
            'title' => 'Quran final tests',
            'empty' => 'No final Quran tests have been recorded yet.',
            'headers' => [
                'date' => 'Date',
                'group' => 'Group',
                'juz' => 'Juz',
        ...
        'awqaf_tests' => [
            'title' => 'Awqaf tests',
            'empty' => 'No awqaf tests have been recorded yet.',
            'headers' => [
                'date' => 'Date',
                'group' => 'Group',
                'juz' => 'Juz',
