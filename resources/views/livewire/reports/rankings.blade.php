...
new class extends Component {
    ...
    public function with(): array
    {
        ...
        return [
            ...
            'groups' => $this->scopeGroupsQuery(Group::query()->visibleInReportFilters()->when($this->course_id, fn ($query) => $query->where('course_id', $this->course_id))->orderBy('name'))->get(['id', 'name', 'course_id']),
