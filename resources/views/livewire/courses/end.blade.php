...
<div class="page-stack">
    ...
    <section class="surface-panel p-5 lg:p-6"><div class="admin-toolbar"><div class="admin-toolbar__title">{{ __('course_end.report_cards') }}</div><div class="admin-toolbar__actions"><a href="{{ route('print-templates.print.create', ['course_id' => $course->id]) }}" class="pill-link pill-link--accent">{{ __('course_end.print_cards') }}</a></div></div></section>
</div>
