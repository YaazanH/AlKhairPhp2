...
new class extends Component {
    ...
    public ?int $request_category_id = null;
    ...
    public function with(): array
    {
        ...
        $transactions = FinanceTransaction::query()
            ...
            ->with(['cashBox', 'category', 'currency', 'enteredBy'])
    ...
    public function createRequest(): void
    {
        ...
        $validated = $this->validate([
            ...
            'request_category_id' => ['required', 'exists:finance_categories,id'],
        ...
        FinanceRequest::query()->create([
            ...
            'finance_category_id' => $validated['request_category_id'],
            'requested_by' => $teacher->user?->id ?: auth()->id(),
            'requested_reason' => $validated['request_reason'] ?: null,
        ]);

        $this->reset(['request_amount', 'request_reason', 'request_teacher_id', 'request_category_id', 'request_kind_id', 'showCreateRequestModal']);
        session()->flash('status', __('finance.messages.pull_sent'));
    }
