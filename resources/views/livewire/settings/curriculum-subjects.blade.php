...
new class extends Component {
    ...
    public function saveResource(): void
    {
        $data = $this->validate([
            ...
            'author' => ['nullable', 'string', 'max:255'], 'publisher' => ['nullable', 'string', 'max:255'], 'publishedOn' => ['nullable', 'integer', 'digits:4', 'between:1000,9999'],
        ]);
