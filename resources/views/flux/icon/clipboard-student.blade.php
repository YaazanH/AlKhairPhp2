...
<x-sidebar-outline-icon :$variant {{ $attributes }}>
    <defs>
        <mask id="clipboard-student-cutout" maskUnits="userSpaceOnUse">
            ...
            <path d="m.75 16.25 6.75-3.4 6.75 3.4-6.75 3.4zM2.25 18.5v3c3 1.9 7.5 1.9 10.5 0v-3" fill="black" stroke="black" stroke-width="2.5" transform="translate(-1.2 -2.2) scale(1.1)" />
        </mask>
    </defs>
    ...
    <g data-attendance-badge="graduation-cap" transform="translate(-1.2 -2.2) scale(1.1)">
