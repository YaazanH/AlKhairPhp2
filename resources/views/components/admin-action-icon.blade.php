...
@php
    $isSuppliedFilledIcon = in_array($name, ['save', 'save-new', 'unlink', 'financial-report-open', 'financial-report-create', 'expense-invoice-view', 'transaction-invoice-edit', 'review', 'past'], true);
    $viewBox = match ($name) {
