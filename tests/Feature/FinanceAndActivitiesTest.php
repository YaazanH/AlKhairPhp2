...
class FinanceAndActivitiesTest extends TestCase
{
    ...
    public function test_finance_dashboard_limits_latest_activity_and_exposes_category_percentage(): void
    {
        ...
        $this->assertStringContainsString('<col style="width: 8.7125%" data-finance-reduced-column="credit" data-finance-left-column data-finance-left-weight="8.7125">', $financeDashboardSource);
        $this->assertStringContainsString('<col style="width: 8.7125%" data-finance-reduced-column="debit" data-finance-left-column data-finance-left-weight="8.7125">', $financeDashboardSource);
        $this->assertStringContainsString('<col style="width: 10.05%" data-finance-reduced-column="balance" data-finance-left-column data-finance-left-weight="10.05">', $financeDashboardSource);
        $this->assertSame(8, substr_count($financeDashboardSource, 'data-finance-spacing-content='));
        ...
        $this->assertStringContainsString("? labels.filter((label) => label.hasAttribute('data-finance-kashida-target'))", $financeTableJs);
        $this->assertStringContainsString("spacingColumns[index] === 'category' ? width * 2 : width", $financeTableJs);
        ...
        $this->assertStringContainsString('data-finance-double-width', $financeDashboardSource);
